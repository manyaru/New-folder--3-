            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">ALVIN MUREITHI </span>
                 and I'm from <span className="yellow"> NAIROBI, KENYA</span>
                <br />
                <br />
                I recently graduated from GoMyCode Kenya with a certification in Software Development in 2024.
                 <br />
                <br />
                  As a
              ...
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  <li className="social-icons">
                    <a
                      href="https://github.com/manyaru?tab=repositories"
                      target="_blank"
                      rel="noreferrer"
